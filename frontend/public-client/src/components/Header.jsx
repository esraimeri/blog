            ...
            <ul className={"flex flex-col gap-4 p-2 w-max underline border-2"}>
              <li>
                <NavigationMenuLink
                  ...
                  href="https://admin-blog-three.vercel.app/admin/1"
                  target="_blank"
                >
                  Admin
                </NavigationMenuLink>
              ...
              <li>
                <Link className="link cursor-pointer" to="/all-posts/1">
                  All Posts
                </Link>
              </li>
              <li>
                <NavigationMenuLink
                  className="link cursor-pointer"
                  href="https://github.com/esraimeri"
                  target="_blank"
                >
                  About Me
                </NavigationMenuLink>
  ...
  return (
    <header className="max-w-[1200px] mx-auto max-sm:px-4 px-[70px] py-5 flex items-center justify-between">
      ...
      <nav className="hidden md:flex gap-16 underline ">
        <a
          href="https://admin-blog-three.vercel.app/"
          target="_blank"
